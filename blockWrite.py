...
# command-line input
help_text = """Usage: makeBMD.py <hex size [m]> [expand_factor] """

try:    #try block lets you test a block of code for errors
    if len(sys.argv) > 1:   #sys.argv the list of commend arguments passed to a Python script
